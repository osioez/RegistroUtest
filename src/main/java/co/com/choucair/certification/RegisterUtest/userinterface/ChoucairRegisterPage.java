...
public class ChoucairRegisterPage extends PageObject {
    ...
    public static final Target SELECT_LANGUAGE = Target.the("Select the language").located(By.id("languages"));
    ...
    public static final Target INPUT_PC = Target.the("Select you devices").located(By.id("focusser-22"));
    //public static final Target SELECT_VERSION = Target.the("Select the version").located(By.id("focusser-15"));
    ...
    //public static final Target NEXT_BUTTON2 = Target.the("Next previus page").located(By.xpath("//div[@class='pull-right next-step']//a[@class='btn btn-blue pull-right']"));

    //Pagina4

    //public static final Target INPUT_PASS = Target.the("Where do we write the password").located(By.id("password"));
    //public static final Target INPUT_CONFIPASS = Target.the("Where do we rewrite the password").located(By.id("confirmPassword"));
    //public static final Target CHECK_TERM = Target.the("confirm the terms").located(By.xpath("//label[@class='input-check-box signup-consent']//input[@id='termOfUse']"));
    //public static final Target CHECK_PRIVACY = Target.the("confirm the privacy").located(By.xpath("//label[@class='input-check-box signup-consent']//input[@id='privacySetting']"));
    //public static final Target NEXT_BUTTON3 = Target.the("Save").located(By.xpath("//div[@class='pull-right next-step']//a[@class='btn btn-blue']"));
